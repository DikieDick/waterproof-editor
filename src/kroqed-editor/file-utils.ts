import { DocChange, Message, MessageType, WrappingDocChange } from "@common";
...
/**
	 ...
	 */
export function checkPrePost(content: string, post: (msg: Message) => void): string {
    let result = content
...
export function fixLessThanBug(content: string, post: (msg: Message) => void): string {
